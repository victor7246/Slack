...
(function (global, factory) {
    ...
    (factory((global.RSStorage = global.RSStorage || {})));
 ...
 * Internal Operations
 *****************************************************************/
var InternalStorage = (function (Storage) {
  function InternalStorage(dbInfo, ll) {
    Storage.call(this, dbInfo, ll);
  }

  if ( Storage ) InternalStorage.__proto__ = Storage;
  InternalStorage.prototype = Object.create( Storage && Storage.prototype );
  InternalStorage.prototype.constructor = InternalStorage;

  ///////////////////////////////////////////////////////////////////////////////////////////////
  // NOTE: Overloads required so internal storage message database can access data for all sifts
  ///////////////////////////////////////////////////////////////////////////////////////////////
  InternalStorage.prototype.get = function get (params, siftGuid) {
    this._logger.trace('[InternalStorage::get]: ', params, siftGuid);
    return opGet(_dbs.get(this), params, siftGuid || _siftGuid.get(this));
  };

  InternalStorage.prototype.getAll = function getAll (params, siftGuid) {
  ...
  InternalStorage.prototype.getAllKeys = function getAllKeys (params, siftGuid) {
  ...
  InternalStorage.prototype.getIndex = function getIndex (params, siftGuid) {
  ...
  InternalStorage.prototype.getIndexKeys = function getIndexKeys (params, siftGuid) {
  ...
  InternalStorage.prototype.getWithIndex = function getWithIndex (params, siftGuid) {
...
},{"../dist/js/rs-storage.umd-es2015.js":1}]},{},[2]);
